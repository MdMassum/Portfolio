...
function Frontend() {
  ...
  return (
    <motion.div 
      ...
      className='flex flex-col items-center p-6 shadow-lg rounded-lg max-w-md mx-auto transform transition-transform duration-300 hover:scale-105 cursor-pointer dark:bg-gradient-to-b dark:from-gray-300 dark:via-gray-50 dark:to-gray-400'
    >
