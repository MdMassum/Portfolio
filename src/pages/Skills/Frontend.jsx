...
function Frontend() {
  ...
  return (
    <motion.div 
      ...
      className='flex flex-col items-center p-6 shadow-lg rounded-lg max-w-md mx-auto transform transition-transform duration-300 hover:scale-105 cursor-pointer bg-gradient-to-b from-gray-300 via-gray-50 to-gray-400'
    >
