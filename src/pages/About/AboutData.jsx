...
function AboutData() {
  ...
  return (
    <motion.div ref={ref} className='flex flex-col gap-6'>
      ...
      >
        <div className='w-46 flex flex-col shadow-md justify-center items-center p-4 ml-10 md:ml-0 rounded-lg bg-white hover:scale-105 transition-transform ease-in-out cursor-pointer bg-gradient-to-b from-gray-300 via-gray-50 to-gray-400'>
        ...
        <div className='min-w-46 flex flex-col shadow-md justify-center items-center p-4 rounded-lg bg-white hover:scale-105 transition-transform ease-in-out cursor-pointer bg-gradient-to-b from-gray-300 via-gray-50 to-gray-400'>
