...
function Qualification() {
  ...
  return (
    <div id='skills' className='flex flex-col items-center justify-around md:justify-between p-7 md:px-44 gap-2 dark:bg-slate-800 dark:text-white'>
      ...
      <div className='flex justify-center gap-6 mb-1 mt-10'>
        <button
          className={`flex items-center gap-2 ${activeTab === 'Education' ? 'text-blackwhite dark:text- font-semibold' : 'text-gray-500 dark:text-gray-300'}`}
