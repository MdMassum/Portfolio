    ...
    <div className="grid grid-cols-[1fr_max-content_1fr]">
      ...
      <div className="flex justify-end border-r-2 border-gray-300 pr-4 pb-8">
        ...
        <div className="text-right -mt-1">
          ...
          <p className="text-gray-400 text-sm">Feb 2026 - Present</p>
        </div>
      </div>
      ...
      <div className="flex justify-start border-l-2 border-gray-300 pl-4 -mx-0.5 pb-10">
        ...
        <div>
          <h4 className="font-semibold">Highway Delite</h4>
          <p className="text-gray-600 dark:text-gray-300">Software Developer (Internship)</p>
          <p className="text-gray-400 text-sm">Aug 2025 - Jan 2026</p>
        </div>
      </div>

      {/* Third item - Right Side */}
      <div className="flex justify-end border-r-2 border-gray-300 pr-4 pb-10">
        {/* Data */}
        <div className="text-right">
          <h4 className="font-semibold">Skillancer Private Limited</h4>
          <p className="text-gray-600 dark:text-gray-300">FullStack Developer (Internship)</p>
