    ...
    <div className='flex justify-center items-center gap-20 overflow-hidden'>
      ...
      >
        <a 
          ...
          href="https://www.instagram.com/m.massum_12/" target='_blank' 
        ...
        <a 
          ...
          href="https://www.linkedin.com/in/md-emamudin-42576421b/" target='_blank' 
          className='text-gray-600 hover:text-gray-900 dark:text-gray-300 hover:dark:text-white'>
          <FaLinkedin className='h-8 w-8' />
        </a>
        <a 
          onClick={() => handleSocialClick("GitHub")}
          href="https://github.com/MdMassum" target='_blank' 
          className='text-gray-600 hover:text-gray-900 dark:text-gray-300 hover:dark:text-white'>
